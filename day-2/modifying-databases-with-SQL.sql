...
1. In this first step, use UPDATE to change the author to 'Jackie Draper' for all rows where it's currently 'Jackie Paper'.
...
INSERT INTO clothes (type, design, price) VALUES("cardigan", "chevron", 40);
